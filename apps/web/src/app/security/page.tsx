        ...
        <div className="container px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <Link
                href="/login"
                className="flex flex-col items-center gap-2 p-4 rounded-3xl bg-background border hover:border-primary/50 hover:bg-primary/5 transition-colors text-center"
              >
              ...
              <a
                href="mailto:support@rukny.xyz?subject=طوارئ أمنية"
                className="flex flex-col items-center gap-2 p-4 rounded-3xl bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900 hover:bg-red-100 dark:hover:bg-red-950/50 transition-colors text-center"
              >
                <AlertTriangle className="size-6 text-red-600" />
                <span className="text-sm font-medium text-red-700 dark:text-red-400">إبلاغ عن اختراق</span>
              </a>
            </div>
          </div>
        </div>
